...
exports.teamDetails = async (req, res) => {
  ...
  api.response(req, res, 'teamDetails', url)
}
...
exports.teamLogos = async (req, res) => {
  ...
  if (result) {
    ...
    api.responseForImages(req, res, 'teamLogos', url)
  } else {
