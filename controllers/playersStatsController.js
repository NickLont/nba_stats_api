...
exports.allPlayers = async (req, res) => {
  ...
  api.getResponse(req, res, 'allPlayers', url)
}
...
exports.playerCareerInfo = async (req, res) => {
  ...
  api.getResponse(req, res, 'playerCareerInfo', url)
}
exports.playersLeagueLeaders = async (req, res) => {
  ...
  api.getResponse(req, res, 'playersLeagueLeaders', url)
}
exports.playerYearOverYear = async (req, res) => {
  ...
  api.getResponse(req, res, 'playerYearOverYear', url)
}
exports.playerShotChart = async (req, res) => {
  ...
  api.getResponse(req, res, 'playerShotChart', url)
}
