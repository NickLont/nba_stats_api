...
exports.allPlayers = async (req, res) => {
  ...
  api.response(req, res, 'allPlayers', url)
}
...
exports.playerCareerInfo = async (req, res) => {
  ...
  api.response(req, res, 'playerCareerInfo', url)
}
exports.playersLeagueLeaders = async (req, res) => {
  ...
  api.response(req, res, 'playersLeagueLeaders', url)
}
exports.playerYearOverYear = async (req, res) => {
  ...
  api.response(req, res, 'playerYearOverYear', url)
}
exports.playerShotChart = async (req, res) => {
  ...
  api.response(req, res, 'playerShotChart', url)
}
